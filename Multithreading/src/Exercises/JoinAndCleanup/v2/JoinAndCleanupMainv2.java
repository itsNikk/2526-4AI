...
public class JoinAndCleanupMainv2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ElaborationEntityv2[] entities = new ElaborationEntityv2[NUM_PROCESSI];
        for (int i = 0; i < NUM_PROCESSI; i++) entities[i] = new ElaborationEntityv2(ENTITY_PREFIX + "-" + (i + 1));

        for (ElaborationEntityv2 p : entities) p.start();
        ...
        long remaining;
        for (ElaborationEntityv2 p : entities) {
